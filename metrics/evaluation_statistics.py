...
def compute_contact(
    ...
    # Defensive: can happen for tiny graphs (N<2) or degenerate distances.
    # In that case, "contact" metrics are undefined; return NaNs so caller can ignore.
    ...
    # sklearn can warn/error if a class is missing; treat as undefined.
    try:
