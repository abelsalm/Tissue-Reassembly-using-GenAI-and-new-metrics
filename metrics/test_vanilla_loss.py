# This was used at the beginning as LUNA' training loss, it was kept for validation to have information on that still...
...
class LossFunction(nn.Module):
    """VanillaLoss class for computing and logging training metrics.
    ...
    def log_epoch_metrics(self, train_stage: bool = True) -> Dict[str, float]:
        """Log epoch-level metrics for position MSE.
